...
- `session_affinity_attributes` (Block Set) See [`session_affinity_attributes`](#session_affinity_attributes). Note that the property [`drain_duration`](#drain_duration) is not currently supported as a rule override. (see [below for nested schema](#nestedblock--rules--overrides--session_affinity_attributes))
...
- `samesite` (String) See [`samesite`](#samesite).
- `secure` (String) See [`secure`](#secure).
- `zero_downtime_failover` (String) See [`zero_downtime_failover`](#zero_downtime_failover).
